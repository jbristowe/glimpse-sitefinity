// ListOfAppModuleSettingsConverter.cs
...
{
    public sealed class ListOfAppModuleSettingsConverter : SerializationConverter<ConfigElementDictionary<string, AppModuleSettings>>
    {
        public override object Convert(ConfigElementDictionary<string, AppModuleSettings> obj)
        {
